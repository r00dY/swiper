...
var AbstractSwiper = function(optionsArg, gesturesProvider) {
  var _this = this;

  this._gesturesProvider = gesturesProvider;
  /**
   * Resolve options
   */
...
AbstractSwiper.prototype.enable = function() {
  ...
  if (this._gesturesProvider) {
    this._gesturesProvider.enable(this);
    return;
  }
...
var SimpleSwiper = function(options, gesturesProvider, container, innerContainer) {

  var _this = this;

  AbstractSwiper.call(this, options, gesturesProvider);

  this._container = typeof container != 'undefined' ? container : document.querySelector(this._getSelectorForComponent('container'));
  this._containerInner = typeof innerContainer != 'undefined' ? innerContainer : this._container.querySelector('.swiper-items');
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Factory__ = __webpack_require__(8);
var $ = __webpack_require__(2);
__webpack_require__(3);
...
global.SimpleSwiperFactory = __WEBPACK_IMPORTED_MODULE_0__Factory__["a" /* default */];
global.$ = $;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__GesturesProvider__ = __webpack_require__(9);
var SimpleSwiper = __webpack_require__(4);
var AbstractSwiper = __webpack_require__(0);
...
class SwiperFactory {
    createSwiper(options) {
        ...
        let swiper = new SimpleSwiper(
            options,
            new __WEBPACK_IMPORTED_MODULE_0__GesturesProvider__["a" /* default */]({}, document.querySelector(AbstractSwiper.getSelectorForComponent('touch-space', options.name))),
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SwiperFactory;
...
let AbstractSwiper = __webpack_require__(0);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = GesturesProvider;
